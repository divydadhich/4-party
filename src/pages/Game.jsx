...
import roomEffect from "../assets/room.jpg"
...
<span className="text-sm opacity-90 min-w-[44px] text-right">
  Lv.{nextLevel}
    ...
    <p className="text-xs opacity-90">
      Requires 189330 Experience Upgrade
    </p>
  </div>
</div>
...
<div className="space-y-4">
  {[
    ...
    <div
      key={lvl}
      className="grid grid-cols-3 gap-4 items-center px-1"
    >
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#ff9a9e] to-[#fad0c4]
                        ...
                        <img src={G} alt="Buy a Car" className="w-8 h-8 object-contain" />

              </div>
              <div>
                <p className="font-medium">Earn points by playing games</p>
